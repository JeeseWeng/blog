...
# <center>2021 年我的前端知识</center>

- [<center>2021 年我的前端知识</center>](#center2021-%E5%B9%B4%E6%88%91%E7%9A%84%E5%89%8D%E7%AB%AF%E7%9F%A5%E8%AF%86center)
  ...
  - [三、JS 相关](#%E4%B8%89js-%E7%9B%B8%E5%85%B3)
    - [（五）JS 函数柯里化](#%E4%BA%94js-%E5%87%BD%E6%95%B0%E6%9F%AF%E9%87%8C%E5%8C%96)
    - [（六）实现继承](#%E5%85%AD%E5%AE%9E%E7%8E%B0%E7%BB%A7%E6%89%BF)
    - [（七）数据结构复杂度](#%E4%B8%83%E6%95%B0%E6%8D%AE%E7%BB%93%E6%9E%84%E5%A4%8D%E6%9D%82%E5%BA%A6)
  - [四、ES6](#%E5%9B%9Bes6)
    - [（一）大概](#%E4%B8%80%E5%A4%A7%E6%A6%82)
    - [（二）ES6 里的 symble](#%E4%BA%8Ces6-%E9%87%8C%E7%9A%84-symble)
  ...
  - [五、Vue](#%E4%BA%94vue)
    - [1. 简述 MVVM](#1-%E7%AE%80%E8%BF%B0-mvvm)
    - [2. 谈谈对 vue 生命周期的理解？](#2-%E8%B0%88%E8%B0%88%E5%AF%B9-vue-%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F%E7%9A%84%E7%90%86%E8%A7%A3)
    - [3. computed 与 watch](#3-computed-%E4%B8%8E-watch)
    - [4. v-for 中 key 的作用](#4-v-for-%E4%B8%AD-key-%E7%9A%84%E4%BD%9C%E7%94%A8)
    - [5. vue 组件的通信方式](#5-vue-%E7%BB%84%E4%BB%B6%E7%9A%84%E9%80%9A%E4%BF%A1%E6%96%B9%E5%BC%8F)
    - [6. 常用指令](#6-%E5%B8%B8%E7%94%A8%E6%8C%87%E4%BB%A4)
    - [7. 双向绑定实现原理](#7-%E5%8F%8C%E5%90%91%E7%BB%91%E5%AE%9A%E5%AE%9E%E7%8E%B0%E5%8E%9F%E7%90%86)
    - [8. v-model 的实现以及它的实现原理？](#8-v-model-%E7%9A%84%E5%AE%9E%E7%8E%B0%E4%BB%A5%E5%8F%8A%E5%AE%83%E7%9A%84%E5%AE%9E%E7%8E%B0%E5%8E%9F%E7%90%86)
    - [9. nextTick 的实现](#9-nexttick-%E7%9A%84%E5%AE%9E%E7%8E%B0)
    - [10. vnode 的理解，compiler 和 patch 的过程](#10-vnode-%E7%9A%84%E7%90%86%E8%A7%A3compiler-%E5%92%8C-patch-%E7%9A%84%E8%BF%87%E7%A8%8B)
    - [11. new Vue 后整个的流程](#11-new-vue-%E5%90%8E%E6%95%B4%E4%B8%AA%E7%9A%84%E6%B5%81%E7%A8%8B)
    ...
    - [12. keep-alive 的实现](#12-keep-alive-%E7%9A%84%E5%AE%9E%E7%8E%B0)
      - [钩子函数：](#%E9%92%A9%E5%AD%90%E5%87%BD%E6%95%B0)
      - [配置属性：](#%E9%85%8D%E7%BD%AE%E5%B1%9E%E6%80%A7)
    - [13. vuex、vue-router 实现原理](#13-vuexvue-router-%E5%AE%9E%E7%8E%B0%E5%8E%9F%E7%90%86)
    - [14. 你怎么理解 Vue 中的 diff 算法?](#14-%E4%BD%A0%E6%80%8E%E4%B9%88%E7%90%86%E8%A7%A3-vue-%E4%B8%AD%E7%9A%84-diff-%E7%AE%97%E6%B3%95)
    - [15. 你都做过哪些 Vue 的性能优化？](#15-%E4%BD%A0%E9%83%BD%E5%81%9A%E8%BF%87%E5%93%AA%E4%BA%9B-vue-%E7%9A%84%E6%80%A7%E8%83%BD%E4%BC%98%E5%8C%96)
      - [编码阶段](#%E7%BC%96%E7%A0%81%E9%98%B6%E6%AE%B5)
      - [用户体验](#%E7%94%A8%E6%88%B7%E4%BD%93%E9%AA%8C)
    - [16. 你知道 Vue3 有哪些新特性吗？它们会带来什么影响？](#16-%E4%BD%A0%E7%9F%A5%E9%81%93-vue3-%E6%9C%89%E5%93%AA%E4%BA%9B%E6%96%B0%E7%89%B9%E6%80%A7%E5%90%97%E5%AE%83%E4%BB%AC%E4%BC%9A%E5%B8%A6%E6%9D%A5%E4%BB%80%E4%B9%88%E5%BD%B1%E5%93%8D)
      - [性能提升](#%E6%80%A7%E8%83%BD%E6%8F%90%E5%8D%87)
      - [API 变动](#api-%E5%8F%98%E5%8A%A8)
      - [检测机制](#%E6%A3%80%E6%B5%8B%E6%9C%BA%E5%88%B6)
    - [17. 实现双向绑定 Proxy 与 Object.defineProperty 相比优劣如何?](#17-%E5%AE%9E%E7%8E%B0%E5%8F%8C%E5%90%91%E7%BB%91%E5%AE%9A-proxy-%E4%B8%8E-objectdefineproperty-%E7%9B%B8%E6%AF%94%E4%BC%98%E5%8A%A3%E5%A6%82%E4%BD%95)
    - [18. vue 的 key](#18-vue-%E7%9A%84-key)
    - [19. mapState, mapGetters, mapActions, mapMutations](#19-mapstate-mapgetters-mapactions-mapmutations)
  - [六、React](#%E5%85%ADreact)
    - [1. react 中 key 的作用，有 key 没 key 有什么区别，比较同一层级节点什么意思？](#1-react-%E4%B8%AD-key-%E7%9A%84%E4%BD%9C%E7%94%A8%E6%9C%89-key-%E6%B2%A1-key-%E6%9C%89%E4%BB%80%E4%B9%88%E5%8C%BA%E5%88%AB%E6%AF%94%E8%BE%83%E5%90%8C%E4%B8%80%E5%B1%82%E7%BA%A7%E8%8A%82%E7%82%B9%E4%BB%80%E4%B9%88%E6%84%8F%E6%80%9D)
    - [2. 对虚拟 dom 和 diff 算法的理解，实现 render 函数](#2-%E5%AF%B9%E8%99%9A%E6%8B%9F-dom-%E5%92%8C-diff-%E7%AE%97%E6%B3%95%E7%9A%84%E7%90%86%E8%A7%A3%E5%AE%9E%E7%8E%B0-render-%E5%87%BD%E6%95%B0)
    - [3. React 组件之间通信方式？](#3-react-%E7%BB%84%E4%BB%B6%E4%B9%8B%E9%97%B4%E9%80%9A%E4%BF%A1%E6%96%B9%E5%BC%8F)
    - [4. 如何解析 jsx](#4-%E5%A6%82%E4%BD%95%E8%A7%A3%E6%9E%90-jsx)
    - [5. 生命周期都有哪几种，分别是在什么阶段做哪些事情？为什么要废弃一些生命周期？](#5-%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F%E9%83%BD%E6%9C%89%E5%93%AA%E5%87%A0%E7%A7%8D%E5%88%86%E5%88%AB%E6%98%AF%E5%9C%A8%E4%BB%80%E4%B9%88%E9%98%B6%E6%AE%B5%E5%81%9A%E5%93%AA%E4%BA%9B%E4%BA%8B%E6%83%85%E4%B8%BA%E4%BB%80%E4%B9%88%E8%A6%81%E5%BA%9F%E5%BC%83%E4%B8%80%E4%BA%9B%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F)
    - [6. 关于 react 的优化方法](#6-%E5%85%B3%E4%BA%8E-react-%E7%9A%84%E4%BC%98%E5%8C%96%E6%96%B9%E6%B3%95)
    - [7. 绑定 this 的几种方式](#7-%E7%BB%91%E5%AE%9A-this-%E7%9A%84%E5%87%A0%E7%A7%8D%E6%96%B9%E5%BC%8F)
    - [8. 对 fiber 的理解](#8-%E5%AF%B9-fiber-%E7%9A%84%E7%90%86%E8%A7%A3)
    - [9. setState 是同步还是异步的](#9-setstate-%E6%98%AF%E5%90%8C%E6%AD%A5%E8%BF%98%E6%98%AF%E5%BC%82%E6%AD%A5%E7%9A%84)
    - [10. Redux、React-Redux](#10-reduxreact-redux)
    - [11. 对高阶组件的理解](#11-%E5%AF%B9%E9%AB%98%E9%98%B6%E7%BB%84%E4%BB%B6%E7%9A%84%E7%90%86%E8%A7%A3)
      - [高阶组件的作用：](#%E9%AB%98%E9%98%B6%E7%BB%84%E4%BB%B6%E7%9A%84%E4%BD%9C%E7%94%A8)
    - [12. 可以用哪些方式创建 React 组件？](#12-%E5%8F%AF%E4%BB%A5%E7%94%A8%E5%93%AA%E4%BA%9B%E6%96%B9%E5%BC%8F%E5%88%9B%E5%BB%BA-react-%E7%BB%84%E4%BB%B6)
    - [13. React 元素与组件的区别？](#13-react-%E5%85%83%E7%B4%A0%E4%B8%8E%E7%BB%84%E4%BB%B6%E7%9A%84%E5%8C%BA%E5%88%AB)
  - [七、Vue 与 React 对比？](#%E4%B8%83vue-%E4%B8%8E-react-%E5%AF%B9%E6%AF%94)
  - [八、vuex 和 redux 之间的区别？](#%E5%85%ABvuex-%E5%92%8C-redux-%E4%B9%8B%E9%97%B4%E7%9A%84%E5%8C%BA%E5%88%AB)
  - [九、浏览器从输入 url 到渲染页面，发生了什么？](#%E4%B9%9D%E6%B5%8F%E8%A7%88%E5%99%A8%E4%BB%8E%E8%BE%93%E5%85%A5-url-%E5%88%B0%E6%B8%B2%E6%9F%93%E9%A1%B5%E9%9D%A2%E5%8F%91%E7%94%9F%E4%BA%86%E4%BB%80%E4%B9%88)
  - [十、网络安全、HTTP 协议](#%E5%8D%81%E7%BD%91%E7%BB%9C%E5%AE%89%E5%85%A8http-%E5%8D%8F%E8%AE%AE)
    - [1. TCP UDP 区别](#1-tcp-udp-%E5%8C%BA%E5%88%AB)
    - [2. Http 和 Https 区别（高频）](#2-http-%E5%92%8C-https-%E5%8C%BA%E5%88%AB%E9%AB%98%E9%A2%91)
    - [3. GET 和 POST 区别（高频）](#3-get-%E5%92%8C-post-%E5%8C%BA%E5%88%AB%E9%AB%98%E9%A2%91)
    - [4. 理解 xss，csrf，ddos 攻击原理以及避免方式](#4-%E7%90%86%E8%A7%A3-xsscsrfddos-%E6%94%BB%E5%87%BB%E5%8E%9F%E7%90%86%E4%BB%A5%E5%8F%8A%E9%81%BF%E5%85%8D%E6%96%B9%E5%BC%8F)
      - [1. XSS(Cross-Site Scripting，跨站脚本攻击)](#1-xsscross-site-scripting%E8%B7%A8%E7%AB%99%E8%84%9A%E6%9C%AC%E6%94%BB%E5%87%BB)
      - [2. CSRF（Cross-site request forgery）跨站请求伪造](#2-csrfcross-site-request-forgery%E8%B7%A8%E7%AB%99%E8%AF%B7%E6%B1%82%E4%BC%AA%E9%80%A0)
      - [3. DDoS 又叫分布式拒绝服务](#3-ddos-%E5%8F%88%E5%8F%AB%E5%88%86%E5%B8%83%E5%BC%8F%E6%8B%92%E7%BB%9D%E6%9C%8D%E5%8A%A1)
    - [5. http 特性以及状态码](#5-http-%E7%89%B9%E6%80%A7%E4%BB%A5%E5%8F%8A%E7%8A%B6%E6%80%81%E7%A0%81)
    - [6. http 三次握手](#6-http-%E4%B8%89%E6%AC%A1%E6%8F%A1%E6%89%8B)
    - [7. http 四次挥手](#7-http-%E5%9B%9B%E6%AC%A1%E6%8C%A5%E6%89%8B)
    - [8. http1.0、http1.1、http2.0 的区别](#8-http10http11http20-%E7%9A%84%E5%8C%BA%E5%88%AB)
    - [9. http 如何实现缓存](#9-http-%E5%A6%82%E4%BD%95%E5%AE%9E%E7%8E%B0%E7%BC%93%E5%AD%98)
    - [10. 输入 url 后 http 请求的完整过程](#10-%E8%BE%93%E5%85%A5-url-%E5%90%8E-http-%E8%AF%B7%E6%B1%82%E7%9A%84%E5%AE%8C%E6%95%B4%E8%BF%87%E7%A8%8B)
    - [11. 从输入 url 到展示的过程](#11-%E4%BB%8E%E8%BE%93%E5%85%A5-url-%E5%88%B0%E5%B1%95%E7%A4%BA%E7%9A%84%E8%BF%87%E7%A8%8B)
    - [12. osi7 层模型，tcp5 层模型](#12-osi7-%E5%B1%82%E6%A8%A1%E5%9E%8Btcp5-%E5%B1%82%E6%A8%A1%E5%9E%8B)
  - [十一、前端性能优化](#%E5%8D%81%E4%B8%80%E5%89%8D%E7%AB%AF%E6%80%A7%E8%83%BD%E4%BC%98%E5%8C%96)
    - [（一）前端性能优化的几种方式](#%E4%B8%80%E5%89%8D%E7%AB%AF%E6%80%A7%E8%83%BD%E4%BC%98%E5%8C%96%E7%9A%84%E5%87%A0%E7%A7%8D%E6%96%B9%E5%BC%8F)
      - [三个方面来说明前端性能优化](#%E4%B8%89%E4%B8%AA%E6%96%B9%E9%9D%A2%E6%9D%A5%E8%AF%B4%E6%98%8E%E5%89%8D%E7%AB%AF%E6%80%A7%E8%83%BD%E4%BC%98%E5%8C%96)
        - [一、webapck 优化与开启 gzip 压缩](#%E4%B8%80webapck-%E4%BC%98%E5%8C%96%E4%B8%8E%E5%BC%80%E5%90%AF-gzip-%E5%8E%8B%E7%BC%A9)
        - [二、本地存储——从 Cookie 到 Web Storage、IndexedDB](#%E4%BA%8C%E6%9C%AC%E5%9C%B0%E5%AD%98%E5%82%A8%E4%BB%8E-cookie-%E5%88%B0-web-storageindexeddb)
    ...
    - [（三）前后端如何通信](#%E4%B8%89%E5%89%8D%E5%90%8E%E7%AB%AF%E5%A6%82%E4%BD%95%E9%80%9A%E4%BF%A1)
    - [（四）跨域通信的几种方式](#%E5%9B%9B%E8%B7%A8%E5%9F%9F%E9%80%9A%E4%BF%A1%E7%9A%84%E5%87%A0%E7%A7%8D%E6%96%B9%E5%BC%8F)
    - [（五）浏览器的本地存储以及各自优劣](#%E4%BA%94%E6%B5%8F%E8%A7%88%E5%99%A8%E7%9A%84%E6%9C%AC%E5%9C%B0%E5%AD%98%E5%82%A8%E4%BB%A5%E5%8F%8A%E5%90%84%E8%87%AA%E4%BC%98%E5%8A%A3)
  ...
  - [十三、面试手写代码系列](#%E5%8D%81%E4%B8%89%E9%9D%A2%E8%AF%95%E6%89%8B%E5%86%99%E4%BB%A3%E7%A0%81%E7%B3%BB%E5%88%97)
    ...
    - [（三）对象深浅拷贝](#%E4%B8%89%E5%AF%B9%E8%B1%A1%E6%B7%B1%E6%B5%85%E6%8B%B7%E8%B4%9D)
      ...
      - [1、深拷贝](#1%E6%B7%B1%E6%8B%B7%E8%B4%9D)
  ...
  - [十四、职业技能规划、人事面试](#%E5%8D%81%E5%9B%9B%E8%81%8C%E4%B8%9A%E6%8A%80%E8%83%BD%E8%A7%84%E5%88%92%E4%BA%BA%E4%BA%8B%E9%9D%A2%E8%AF%95)
  - [十五、离职原因](#%E5%8D%81%E4%BA%94%E7%A6%BB%E8%81%8C%E5%8E%9F%E5%9B%A0)
  - [十六、其他](#%E5%8D%81%E5%85%AD%E5%85%B6%E4%BB%96)
...
2. initLifecycle：建立父子组件关系，在当前组件实例上添加一些属性和生命周期标识。如[Math Processing Error]parent,parent,refs,$children,\_isMounted 等。
3. initEvents：对父组件传入的事件添加监听，子组件创建事件子组件监听。
4. initRender：声明[Math Processing Error]slots 和 slots 和 createElement()等。
...
1. state(单一状态树) getter/Mutation 显示提交更改 state。
2. Action 类似 Mutation，提交 Mutation，可以包含任意异步操作。
3. module(当应用变得庞大复杂，拆分 store 为具体的 module 模块)
...
- 更小巧、更快速 支持自定义渲染器 支持摇树优化：一种在打包时去除无用代码的优化手段 支持 Fragments 和跨组件渲染
...
- 重写虚拟 DOM 可以期待更多的编译时提示来减少运行时的开销
- 优化插槽生成可以单独渲染父组件和子组件
- 静态树提升降低渲染成本
...
### 19. mapState, mapGetters, mapActions, mapMutations

当一个组件需要获取多个状态时候，将这些状态都声明为计算属性会有些重复和冗余。为了解决这个问题，我们可以使用 mapState 辅助函数帮助我们生成计算属性
mapMutations 其实跟 mapState 的作用是类似的，将组件中的 methods 映射为 store.commit 调用。

## 六、React

### 1. react 中 key 的作用，有 key 没 key 有什么区别，比较同一层级节点什么意思？

Keys 是 React 用于追踪哪些列表中元素被修改、被添加或者被移除的辅助标识。

### 2. 对虚拟 dom 和 diff 算法的理解，实现 render 函数

虚拟 DOM 本质上是 JavaScript 对象,是对真实 DOM 的抽象表现。 状态变更时，记录新树和旧树的差异 最后把差异更新到真正的 dom 中 render 函数:

1. 根据 tagName 生成父标签,读取 props，设置属性，如果有 content，设置 innerHtml 或 innerText。
...
2. http1.x 解析基于文本，http2.0 采用二进制格式，新增特性：多路复用、header 压缩、服务端推送(静态 html 资源)
